...
###############################################################
    def confirm_password_mode():
        ...
        if confirm_pw != '' and confirm_pw != ' Confirm Password':
    ...
    sign_up_button=Button(frame,width=39,pady=7,text='Sign Up',bg='#57a1f8',fg='white',border=0,command=signup).place(x=35,y=240)                              #   y = 260 -> 230
    ...
    confirm_password_toggle_mode = Button(root, width=24,height = 24, pady=7, bd = 0, bg = 'white', command = toggle_confirm_password)            # No need (image = show_password_button,)

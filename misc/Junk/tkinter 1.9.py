...
### Button config ###
button_mode = True
button_on = PhotoImage(file=global_path+"resources/light_mode.png")
button_off = PhotoImage(file=global_path+"resources/dark_mode.png")
...
connection = sqlite3.connect(global_path+'db/accounts.db') # sqlite3.connect(global_path+DB_NAME)                                                                 #   Insert global path
...
###########################################################-REMOVE-###################################################################
    ...
    image = Image.open (global_path+'resources/login.eps')                       
